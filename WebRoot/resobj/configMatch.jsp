  ...
  <body>
  	<div class="easyui-tabs" style="width:1000px;height:800px">
		...
		<table>
			...
			<tr>
				<td><textarea id="addconfig" class="datagrid-editable-input" name="addconfig" style="resize:none;width=470;height=300;color:red" ></textarea></td>
				<td><textarea id="deletefig" class="datagrid-editable-input" name="deletefig" style="resize:none;width=470;height=300;color:blue" ></textarea></td>
			</tr>
			<tr>
				<td>原版本内容：</td>
				<td>比对版本内容：</td>
	...
	<!-- 采集端告警设置 -->
		...
		<table>
			<tr>
				<td>
					<lable>&nbsp;&nbsp;省份：</lable>
			    		<input name="cityCode" id="ch1" class="easyui-combobox" data-options=" valueField: 'id', textField: 'text', url: 'getAllCity.action', 
				...
				<td>
					<lable>&nbsp;&nbsp;单位：</lable>
					<input id="ch2" class="easyui-combobox" name="sbucityCode" data-options="valueField:'id',textField:'text',
						onSelect: function(rec){ 
											var url = 'getResObjByCity.action?cityCode='+rec.id; 
											$('#ch3').combobox('clear');
				...
				<td>
				<lable>防火墙：</lable>
				<input id="ch3" class="easyui-combobox" name="resId" data-options="valueField:'id',textField:'text',
						onSelect: function(rec){ 
				...
				<lable>&nbsp;&nbsp;HA防火墙：</lable>
				<input id="cha3" class="easyui-combobox" name="resId" data-options="valueField:'id',textField:'text',
						onSelect: function(rec){ 
		...
		<table>
			...
			<tr>
				<td><textarea id="haaddconfig" class="datagrid-editable-input" name="addconfig" style="resize:none;width=470;height=300;color:red" ></textarea></td>
				<td><textarea id="hadeletefig" class="datagrid-editable-input" name="deletefig" style="resize:none;width=470;height=300;color:blue"></textarea></td>
			</tr>
			<tr>
				<td>原版本内容：</td>
				<td>比对版本内容：</td>
			...
			<tr>
				<td><textarea id="haconf1" class="datagrid-editable-input" name="haconf1" style="resize:none;width=470;height=300" disabled=true></textarea></td>
				<td><textarea id="haconf2" class="datagrid-editable-input" name="haconf2" style="resize:none;width=470;height=300" disabled=true></textarea></td>
			</tr>
		</table>
		<script type="text/javascript">
			function ss2(){
