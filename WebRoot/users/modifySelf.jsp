...
<body>
	...
	<div class="easyui-panel" title="" style="width:400px">
		...
		<div style="padding:10px 0 10px 60px">
		    <form id="ff" action="modifySelf.action" method="post">
		    ...
		    <input type="hidden" name="orgid" value="${user.orgId }"/>
	    		...
	    		<tr>
	    			...
	    			<td><input class="easyui-validatebox" type="password" missingMessage="请输入密码" name="user.password" data-options="required:true" value="${ user.password}"></input></td>
	    		</tr>
