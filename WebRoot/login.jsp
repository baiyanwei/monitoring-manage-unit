	...
	<div id="wrapper">
		<div id="header" class="true clearfix">
			<div class="container clearfix">
				<span class="site-logo "><font size="5" color="navy">防火墙策略核查系统</font> </span>
		...
		<div class="site clearfix">
			<div id="site-container" class="container" data-pjax-container="">
				<div id="login" class="login_form">
					<form  id="resourceForm" action="login.action" method="post">
						<div style="margin:0;padding:0;display:inline"></div>
						<font color="red">${loginError}</font>
						<h1>请输入认证信息</h1>
						<div class="formbody">
							<label for="login_field"> 登录名称<br> <input autocapitalize="off" autofocus="autofocus" class="text" id="username" name="account" style="width: 21em;" tabindex="1" type="text"> </label> <label for="password"> 密码 <br> <input
								autocomplete="disabled" class="text" id="passwd" name="password" style="width: 21em;" tabindex="2" type="password"> </label> <label class="submit_btn"><input name="commit" tabindex="3" type="button" value="登录" onclick="myFormSubmit(resourceForm)"> </label>
						</div>
					</form>
				</div>
			</div>
