	...
	<table class="left" cellpadding="0" cellspacing="0" border="0" align="left" id="showtree">
		...
		<tr>
			<td id="td0" class="tree_title_bg1" valign="top">
				<div class="showtree" id="hideleft" onClick="changeFrameleft()" title="隐藏左侧菜单"></div> <span class="data_objshow" onClick="showSubmenu(0);changeColor(0,'content.jsp');">字典维护</span></td>
		</tr>
		<tr class=submunuTbody id=submunuTbody>
			<td valign="top"><iframe src="dictionary_tree.jsp" width="100%" height="100%" frameborder="0" scrolling="auto"></iframe></td>
		</tr>
		<tr>
			<td id="td1" class="tree_title_bg0" valign="top"><span class="data_objshow" onClick="showSubmenu(1);changeColor(1,'content.jsp');">人员授权</span></td>
		</tr>
		<tr class=submunuTbody id=submunuTbody style="display: none">
			<td valign="top"><iframe src="role_tree.jsp" width="100%" height="100%" frameborder="0" scrolling="auto"></iframe></td>
		</tr>
	</table>
