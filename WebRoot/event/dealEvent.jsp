		...
		<div style="padding:10px 0 10px 60px">
		    <form id="ff" action="dealEvent.action" method="post" onsubmit="return submitForm();">
		    	...
		    	<tr>
	    			...
	    			<td>
	    				<input class="easyui-validatebox" type="text" id="level" name="level" value="" />
					</td>
				</tr>
				<tr>
	    			<td><label>事件类型：</label></td>
	    			<td>
	    				 <input class="easyui-validatebox" type="text" id="eventType" value="" />
	    			</td>
	    		</tr>
	    		...
	    		<tr>
	    			...
	    			<td>
	    				<input class="easyui-validatebox" type="text" id="cdate" value="" />
	    			</td>
				...
				<tr>
	    			...
	    			<td>
	    				 <textarea class="datagrid-editable-input"  name="message" style="resize:none;;width=500;height=200"></textarea>
	    			</td>
	    		</tr>
	    		<tr>
	    		...
	    		<tr>
	    			<td>
	    				 <lable>处理信息:</lable></td>
	    			<td>
	    				 <textarea class="datagrid-editable-input" id="dealMsg" name="dealMsg" style="resize:none;width=300;height=100"></textarea>
	    			</td>
	    		</tr>
	    		<tr>
