...
<html>
  <head>
   <%
   		String userDisplay="";
   		String notifyDisplay="";
		List userList =(List)request.getAttribute("lastUser");
		List notifyList =(List)request.getAttribute("notifyUser");
 ...
 <body>
 	...
 	<script>
 		var sell=document.getElementById("selleft");
 		fillSelect(sell, "<%=userDisplay%>");
 		var selr=document.getElementById("selright");
 		fillSelect(selr, "<%=notifyDisplay%>");
 	</script>
 </body>
 </html>