		...
		<div style="padding:10px 0 10px 60px">
		    ...
		    <input type="hidden" name="msg.eventTypeId" value="${ emsg.eventTypeId}"/>
	    		...
	    		<tr>
	    			...
	    			<td><textarea id="msgFormat" class="datagrid-editable-input" name="msg.msgFormat" style="resize:none;width=300;height=100" disabled=true>${ emsg.msgFormat}</textarea></td>
	    		</tr>
	    		<tr>
	    			<td>
	    			&nbsp;
