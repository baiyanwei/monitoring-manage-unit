...
%>
  ...
  <div class="easyui-panel" title="" style="width:700px">
		...
		<div style="padding:10px 0 10px 60px">
		    <form id="ff" action="modifyBaseLineTemplate.action" method="post">
	    		...
	    		<tr>
	    			...
	    			<td>
	    			<select name="companyCode" id="cc1" class="easyui-combobox" data-options=" required:true, valueField: 'id', textField: 'text', url: 'findAllCompany.action'" >
