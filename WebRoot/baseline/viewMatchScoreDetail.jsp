...
%>
    ...
    $("#listDetail").datagrid({  
        ...
        columns:[[  
            ...
            {field:'mcatchResult',title:'比对结果',width:200,editor:'text'} ,
            {field:'cdate',title:'对比时间',width:100,editor:'text',sortable:true},                
            {field:'baselineDesc',title:'基线描述',width:100,editor:'textarea'}, 
            {field:'result',title:'防火墙规则',width:150,editor:'text'}
